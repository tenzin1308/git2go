...
public class DeleteReferenceEndPoint extends RestInteraction {

  private static final Logger logger = LoggerFactory.getLogger(DeleteReferenceEndPoint.class);

  public DeleteReferenceEndPoint(String name) {
    super(name);
  }
