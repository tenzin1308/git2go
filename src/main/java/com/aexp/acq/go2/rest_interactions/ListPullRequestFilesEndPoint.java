...
public class ListPullRequestFilesEndPoint extends RestInteraction {

  private static final Logger logger = LoggerFactory.getLogger(ListPullRequestFilesEndPoint.class);

  public ListPullRequestFilesEndPoint(String name) {
    super(name);
  }
  ...
  protected Object process(Object... vargs) {
    ...
    String target = BaseUtils.stringSubstitutor(App.instance().getProperty("github.api.get.pull.request.files"), tokens);
