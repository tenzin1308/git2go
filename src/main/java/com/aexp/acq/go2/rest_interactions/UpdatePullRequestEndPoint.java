...
public class UpdatePullRequestEndPoint extends RestInteraction {

  private static final Logger logger = LoggerFactory.getLogger(ListPullRequestEndPoint.class);

  public UpdatePullRequestEndPoint(String name) {
    super(name);
  }
  ...
  protected Object process(Object... vargs) {
    ...
    String target = BaseUtils.stringSubstitutor(App.instance().getProperty("github.api.update.pull.request"), tokens);
    return patch(target, body);
  }
