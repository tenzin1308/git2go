...
public class AddLabelsEndPoint extends RestInteraction {

  private static final Logger logger = LoggerFactory.getLogger(AddLabelsEndPoint.class);

  public AddLabelsEndPoint(String name) {
    super(name);
  }
  ...
  protected Object process(Object... vargs) {
    ...
    tokens.put("issue_number", (String)vargs[2]);
    String body = (String)vargs[3];

    String target = BaseUtils.stringSubstitutor(App.instance().getProperty("github.api.add.issue.labels"), tokens);
